...
web2_id=`aws ec2 run-instances --image-id ami-daeb57be --count 1 --instance-type $inst_type --key-name web2 --security-group-ids $web_sg --subnet-id $sub2_pub_id --associate-public-ip-address --query 'Instances[0].InstanceId' --output text`
nfs1_id=`aws ec2 run-instances --image-id ami-daeb57be --count 1 --instance-type $inst_type --key-name nfsserver1 --security-group-ids $nfs_sg --subnet-id $sub1_pvt_id --query 'Instances[0].InstanceId' --output text`
nfs2_id=`aws ec2 run-instances --image-id ami-daeb57be --count 1 --instance-type $inst_type --key-name nfsserver2 --security-group-ids $nfs_sg --subnet-id $sub2_pvt_id --query 'Instances[0].InstanceId' --output text`
sql1_id=`aws ec2 run-instances --image-id ami-daeb57be --count 1 --instance-type $inst_type --key-name sql1 --security-group-ids $sql_sg --subnet-id $sub1_pvt_id --query 'Instances[0].InstanceId' --output text`
sql2_id=`aws ec2 run-instances --image-id ami-daeb57be --count 1 --instance-type $inst_type --key-name sql2 --security-group-ids $sql_sg --subnet-id $sub2_pvt_id --query 'Instances[0].InstanceId' --output text`
